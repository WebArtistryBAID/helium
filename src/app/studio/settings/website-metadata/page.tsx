...
import { getWebsiteMetadataEditorState } from '@/app/studio/settings/website-metadata/website-metadata-actions'
...
export default async function WebsiteMetadataPage({ searchParams }: {
    ...
    const init = await getWebsiteMetadataEditorState()
    ...
    return <WebsiteMetadataEditor init={init} user={user} lockToken={token}/>
}
