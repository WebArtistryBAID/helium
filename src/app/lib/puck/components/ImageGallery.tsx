        ...
        <Swiper key={`${autoplayEnabled}-${delay}`} aria-live={autoplayEnabled ? 'off' : 'polite'} spaceBetween={0} slidesPerView={1}
            ...
            {resolvedSlides.map((slide, index) =>
                <SwiperSlide key={index}>
                    <div className="relative h-[65svh] min-h-[24rem] w-full sm:min-h-[28rem] md:h-screen">
                        ...
                        <div
                            ...
                            <h3 className={`mb-1 max-w-4xl break-words font-bold leading-tight text-white ${
